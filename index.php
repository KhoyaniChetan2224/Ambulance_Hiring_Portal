...
<head>
  ...
  <title>Ambulance Hiring Portal || Home Page</title>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-9.jpg)">
          <div class="container">
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="container">
            <h2>Welcome to <span> Ambulance Hiring Portal</h2>
...
?>
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="ambulancetype" id="ambulancetype" class="form-select">
                ...
                <option value="3">Non- Patient Transport Ambulances</option>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p> If you need immediate assistance or have any urgent inquiries regarding our ambulance hiring services, please don’t hesitate to reach out. Our dedicated team is available 24/7 to help with  requests, provide support, and ensure that your needs are met promptly. Contact us at [Phone Number] or email us at [Email Address], and we will ensure that the appropriate resources are dispatched quickly. Your safety and swift access to  care are our top priorities.</p>
        </div>
