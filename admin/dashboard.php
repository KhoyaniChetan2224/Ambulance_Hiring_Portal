			...
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-2">
					...
					?>
					 ...
					 <h4><a href="manage-ambulance.php" style="color: white">All Ambulance</a></h4>
...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="new-ambulance-request.php" style="color: white"> All New Request</a></h4>
